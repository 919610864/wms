package com.mglj.wms.inside.server.service.impl;

import com.mglj.wms.framework.model.tuples.Pair;
import com.mglj.wms.inside.domain.*;
import com.mglj.wms.inside.server.domain.*;
import com.mglj.wms.inside.server.manager.api.InventoryManager;
import com.mglj.wms.inside.server.service.api.InventoryService;
...
import static com.mglj.wms.framework.model.CommonConstants.DUPLICATE_KEY_AFFECTED_ROWS;
    ...
    public void updateInventory(Collection<InventoryChangeRequest> collection) {
        ...
        if(!CollectionUtils.isEmpty(updateRequestMap)) {
            ...
            for(Map.Entry<InventoryId, List<InventoryChangeRequest>> entry : updateRequestMap.entrySet()) {
                ...
                if(Objects.requireNonNull(inventory).wasOutOfStock()) {
