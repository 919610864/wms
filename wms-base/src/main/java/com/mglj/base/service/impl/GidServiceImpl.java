...
import com.mglj.base.service.api.GidService;
import com.mglj.base.util.NetUtils;
import com.mglj.common.moduling.BasicModule;
			...
			synchronized(this) {
				if(machineNo == -1) {
					try {
						...
						String ip = NetUtils.getHostAddress() + ":" + serverPort;
						Integer sequence = gidServerService.getSequenceOrUpdateEmptyGidServer(ip);
						if(sequence != null) {
							machineNo = sequence;
						} else {
